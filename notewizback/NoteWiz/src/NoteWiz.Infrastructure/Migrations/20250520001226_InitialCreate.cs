        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Color = table.Column<string>(type: "nvarchar(7)", maxLength: 14, nullable: false, defaultValue: "#FFFFFF"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FolderNotes", x => new { x.FolderId, x.NoteId });
                    table.ForeignKey(
                        name: "FK_FolderNotes_Folders_FolderId",
                        column: x => x.FolderId,
                        principalTable: "Folders",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShareMethod = table.Column<int>(type: "int", nullable: false),
